...
package export_talend7_context.export_job_context_0_1;
...
/**
 * Job: export_job_context Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class export_job_context implements TalendJob {
	...
	private final String jobName = "export_job_context";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					export_job_context.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(export_job_context.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class pStruct implements routines.system.IPersistableRow<pStruct> {
		final static byte[] commonByteArrayLock_EXPORT_TALEND7_CONTEXT_export_job_context = new byte[0];
		static byte[] commonByteArray_EXPORT_TALEND7_CONTEXT_export_job_context = new byte[0];
		...
		public String repositoryContextId;

		public String getRepositoryContextId() {
			return this.repositoryContextId;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EXPORT_TALEND7_CONTEXT_export_job_context.length) {
					if (length < 1024 && commonByteArray_EXPORT_TALEND7_CONTEXT_export_job_context.length == 0) {
						commonByteArray_EXPORT_TALEND7_CONTEXT_export_job_context = new byte[1024];
					} else {
						commonByteArray_EXPORT_TALEND7_CONTEXT_export_job_context = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_EXPORT_TALEND7_CONTEXT_export_job_context, 0, length);
				strReturn = new String(commonByteArray_EXPORT_TALEND7_CONTEXT_export_job_context, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_EXPORT_TALEND7_CONTEXT_export_job_context, 0, length);
				strReturn = new String(commonByteArray_EXPORT_TALEND7_CONTEXT_export_job_context, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EXPORT_TALEND7_CONTEXT_export_job_context) {
				...
				try {
					...
					this.internalId = readString(dis);

					this.name = readString(dis);

					this.repositoryContextId = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.internalId, dos);
				...
				writeString(this.repositoryContextId, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("env=" + env);
			sb.append(",internalId=" + internalId);
			sb.append(",name=" + name);
			sb.append(",repositoryContextId=" + repositoryContextId);
			sb.append(",type=" + type);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					String fileName_tFileOutputExcel_1 = context.jobDir + "/jobs_contexts.xlsx";
					...
					xlsxTool_tFileOutputExcel_1.setSheet("job_context");
					...
					if (xlsxTool_tFileOutputExcel_1.getStartRow() == 0) {
						...
						xlsxTool_tFileOutputExcel_1.addCellValue("env");

						xlsxTool_tFileOutputExcel_1.addCellValue("internalId");

						xlsxTool_tFileOutputExcel_1.addCellValue("name");

						xlsxTool_tFileOutputExcel_1.addCellValue("repositoryContextId");
...
// ###############################
					...
					if (isValidFile_tFileInputXML_1) {
						...
						org.dom4j.XPath x_tFileInputXML_1 = doc_tFileInputXML_1.createXPath(nsTool_tFileInputXML_1
								.addDefaultNSPrefix("/talendfile:ProcessType/context/contextParameter"));
...
//init all mapping xpaths
						...
						class XPathUtil_tFileInputXML_1 {
							...
							public void initXPaths_0(java.util.Map<Integer, org.dom4j.XPath> xpaths,
								...
								org.dom4j.XPath xpath_0 = org.dom4j.DocumentHelper
										.createXPath(nsTool.addDefaultNSPrefix("../@name",
												"/talendfile:ProcessType/context/contextParameter"));
								xpath_0.setNamespaceURIs(xmlNameSpaceMap);

								xpaths.put(0, xpath_0);

								org.dom4j.XPath xpath_1 = org.dom4j.DocumentHelper
										.createXPath(nsTool.addDefaultNSPrefix("@internalId",
												"/talendfile:ProcessType/context/contextParameter"));
								...
								org.dom4j.XPath xpath_3 = org.dom4j.DocumentHelper
										.createXPath(nsTool.addDefaultNSPrefix("@repositoryContextId",
												"/talendfile:ProcessType/context/contextParameter"));
								...
								org.dom4j.XPath xpath_4 = org.dom4j.DocumentHelper
										.createXPath(nsTool.addDefaultNSPrefix("@type",
												"/talendfile:ProcessType/context/contextParameter"));
								...
								org.dom4j.XPath xpath_5 = org.dom4j.DocumentHelper
										.createXPath(nsTool.addDefaultNSPrefix("@value",
												"/talendfile:ProcessType/context/contextParameter"));
						...
						for (org.dom4j.Node temp_tFileInputXML_1 : nodeList_tFileInputXML_1) {
							...
							try {
								...
								if (xml_api_tFileInputXML_1.isDefNull(node_tFileInputXML_1)) {
									row1.internalId = null;
								} else if (xml_api_tFileInputXML_1.isEmpty(node_tFileInputXML_1)) {
									row1.internalId = "";
								} else if (xml_api_tFileInputXML_1.isMissing(node_tFileInputXML_1)) {
									row1.internalId = null;
								} else {
									row1.internalId = str_tFileInputXML_1;
								}
								...
								if (xml_api_tFileInputXML_1.isDefNull(node_tFileInputXML_1)) {
									row1.repositoryContextId = null;
								} else if (xml_api_tFileInputXML_1.isEmpty(node_tFileInputXML_1)) {
									row1.repositoryContextId = "";
								} else if (xml_api_tFileInputXML_1.isMissing(node_tFileInputXML_1)) {
									row1.repositoryContextId = null;
								} else {
									row1.repositoryContextId = str_tFileInputXML_1;
								}
...
// # Output table : 'p'
									p_tmp.env = row1.env;
									p_tmp.internalId = row1.internalId;
									p_tmp.name = row1.name;
									p_tmp.repositoryContextId = row1.repositoryContextId;
									p_tmp.type = row1.type;
									p_tmp.value = row1.value;
...
// Start of branch "p"
								if (p != null) {
									...
									if (p.env != null) {
										...
										xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(p.env));
									} else {
										xlsxTool_tFileOutputExcel_1.addCellNullValue();
									}

									if (p.internalId != null) {

										xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(p.internalId));
									} else {
										xlsxTool_tFileOutputExcel_1.addCellNullValue();
									}
									...
									if (p.name != null) {
										...
										xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(p.name));
									} else {
										xlsxTool_tFileOutputExcel_1.addCellNullValue();
									}

									if (p.repositoryContextId != null) {

										xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(p.repositoryContextId));
									} else {
										xlsxTool_tFileOutputExcel_1.addCellNullValue();
									}
									...
									if (p.type != null) {
										...
										xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(p.type));
									} else {
										xlsxTool_tFileOutputExcel_1.addCellNullValue();
									}
									...
									if (p.value != null) {
										...
										xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(p.value));
									} else {
										xlsxTool_tFileOutputExcel_1.addCellNullValue();
									}
...
// # Output table : 'out1'
							out1_tmp.path = ((String) globalMap.get("tFileList_1_CURRENT_FILEPATH"))
									.replace(context.jobDir, "");
...
///////////////////////		
							...
							if (out1.path != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.path));
							...
							if (out1.moment != null) { //
								...
								strBuffer_tLogRow_1
										.append(FormatterUtils.format_Date(out1.moment, "yyyy-MM-dd HH:mm:ss"));
							...
							if (out1.pid != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.pid));
							...
							if (out1.root_pid != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.root_pid));
							...
							if (out1.father_pid != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.father_pid));
							...
							if (out1.project != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.project));
							...
							if (out1.job != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.job));
							...
							if (out1.context != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.context));
							...
							if (out1.priority != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.priority));
							...
							if (out1.type != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.type));
							...
							if (out1.origin != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.origin));
							...
							if (out1.message != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.message));
							...
							if (out1.code != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(out1.code));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final export_job_context export_job_contextClass = new export_job_context();

		int exitCode = export_job_contextClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = export_job_context.class.getClassLoader().getResourceAsStream(
					"export_talend7_context/export_job_context_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = export_job_context.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : export_job_context");
		}
...
/************************************************************************************************
 * 108100 characters generated by Talend Open Studio for Data Integration on the
 * 2023年12月1日 CST 16:04:24
 ************************************************************************************************/